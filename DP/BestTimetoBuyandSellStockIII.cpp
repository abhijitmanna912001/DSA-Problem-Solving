...
public:
    ...
    int solveBySO(vector<int> &prices)
    {
        ...
        vector<vector<vector<int>>> dp(
            2, vector<vector<int>>(2, vector<int>(3, 0)));
    ...
    int solveByTabular(vector<int> &prices)
    {
        int n = prices.size();
        vector<vector<vector<int>>> dp(
    ...
    int maxProfit(vector<int> &prices)
    {
        ...
        return solveByMemo(prices, 0, 1, 2, dp);
    }
    ...
    int maxProfit(vector<int> &prices)
    {
        return solveByRecur(prices, 0, 1, 2);
    }
};
